...
print(f'A média do número de filhos: %.0f' %statistics.mean(matriz[2]))
qtde = 0
media_20_30 = []
for i in range(3):
  for j in range(10):
...
print('A quantidade de filhos das pessoas que tem idade entre 15 a 25 anos: ', qtde)
if sum(media_20_30) > 0:
  print(f'A média de salário de pessoas que tem idade entre 20 a 30 anos: %.2f' %statistics.mean(media_20_30))
else:
