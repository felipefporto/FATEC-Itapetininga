...
for i in range(5):
  ...
  for j in range(5):
    ...
    if matriz[i][j] % 2 == 1 and matriz[i][j] >= 10 and matriz[i][j] <= 15:
      qtde += 1
print('A média dos números multiplos de 3: %.2f' %statistics.mean(mult_3))
print('O menor número da coluna 3, ou seja, índice 2 é: ', menor)
print('A média dos números da 5ª linha da matriz, ou seja, índice 4 é: %.2f' %statistics.mean(media_linha_5))
print('A quantidade de números da matriz que são ímpares, e maiores ou iguais a 10 e menores ou iguais a 15 é: ', qtde)
print('A média dos números de cada linha da matriz :', media_das_linhas)
