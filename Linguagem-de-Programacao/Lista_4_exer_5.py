#Escreva uma função que receba como parâmetro uma lista com 10 nomes e um nome para pesquisa. Essa função deverá realizar uma busca do nome na lista, retornando TRUE se encontrar ou FALSE se não encontrar.
def busca(name):
  if name in nomes:
    return True
  else:
